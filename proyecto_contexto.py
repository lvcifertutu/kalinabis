...
from base_datos import (
    ProyectoRepo,
    ConversacionRepo,
    cargar_memoria as _cargar_memoria_legacy,
    limpiar_memoria as _limpiar_memoria_legacy,
)
